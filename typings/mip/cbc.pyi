...
class SolverCbc(Solver):
    ...
    def add_var(self, obj: numbers.Real = ..., lb: numbers.Real = ..., ub: numbers.Real = ..., coltype: str = ..., column: Optional[Column] = ..., name: str = ...):
        ...
    ...
    def set_processing_limits(self: Solver, max_time: numbers.Real = ..., max_nodes: int = ..., max_sol: int = ..., max_seconds_same_incumbent: int = ..., max_nodes_same_incumbent: float = ...):
        ...
...
class SolverOsi(Solver):
    ...
    def add_var(self, name: str = ..., obj: numbers.Real = ..., lb: numbers.Real = ..., ub: numbers.Real = ..., var_type: str = ..., column: Column = ...):
        ...
