...
class Model:
    ...
    @objective.setter
    def objective(self: Model, objective: Union[numbers.Real, mip.Var, mip.LinExpr, mip.LinExprTensor]):
        ...
    ...
    def lazy_constrs_generator(self: Model, lazy_constrs_generator: Optional[mip.ConstrsGenerator]):
        ...
    ...
    def remove(self: Model, objects: Union[mip.Var, mip.Constr, List[Union[mip.Var, mip.Constr]]]):
...
quicksum = ...
def save_mipstart(sol: List[Tuple[mip.Var, numbers.Real]], file_name: str, obj=...):
